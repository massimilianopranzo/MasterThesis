...
MODEL                = Piston
MODULES              = Piston.c Piston_capi.c Piston_data.c Piston_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c raccel_main.c raccel_sup.c raccel_mat.c simulink_solver_api.c raccel_utils.c slsa_sim_common_utils.c ext_svr.c updown.c ext_work.c rtiostream_interface.c rtiostream_tcpip.c rtiostream_utils.c
PRODUCT              = Piston.exe
MAKEFILE             = Piston.mk
MATLAB_ROOT          = C:/Program Files/MATLAB/R2023b
ALT_MATLAB_ROOT      = C:/PROGRA~1/MATLAB/R2023b
START_DIR            = C:/Universita/MAGISTRALE/MasterThesis/MATLAB/Lens_cell/scriptswave
...
MODELLIB                  = 
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = Piston_ref.rsp
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/raccel/Piston \
